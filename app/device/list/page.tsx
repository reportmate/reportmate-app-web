...
const testDevices = [
  { id: 'SERIAL5135', name: 'Celeste Martin', model: 'MacBook Air (15-inch, M2, 2023)', os: 'macOS 15.2.0' },
  { id: 'SERIAL5122', name: 'Alex Chen', model: 'MacBook Pro (16-inch, M3 Pro, 2023)', os: 'macOS 15.2.0' },
  { id: 'SERIAL5104', name: 'Sarah Kim', model: 'iMac (24-inch, M3, 2023)', os: 'macOS 15.2.0' },
