  ...
  'SERIAL5135': {
    ...
    managedInstalls: {
      ...
      config: {
        ...
        softwareRepoURL: 'https://munki.example.com/deployment',
    ...
    applications: [
      {
        ...
        version: '1.85.2',
        bundleId: 'Microsoft.VisualStudioCode',
        path: 'C:\\Users\\adoe\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe',
        lastOpened: new Date(Date.now() - 600000).toISOString(), // 10 minutes ago
        size: '285 MB'
      },
      {
