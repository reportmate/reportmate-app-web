                      ...
                      <tr>
                        <td colSpan={7} className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center">
                            ...
                            <p className="text-base font-medium text-gray-900 dark:text-white mb-2">Failed to load hardware</p>
                      ...
                      <tr>
                        <td colSpan={7} className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center">
                            ...
                            <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-1">No hardware found</h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400">No hardware matches your current filters.</p>
                          </div>
                        </td>
                      </tr>
                    ) : (
