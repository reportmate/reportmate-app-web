...
// active platform filter. Matches the /installs page categorization.
      ...
      <div className="bg-white dark:bg-gray-800 py-7 px-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500">Warnings</p>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div className="bg-white dark:bg-gray-800 py-7 px-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold text-gray-400 dark:text-gray-500">-</p>
            <p className="text-sm text-gray-400 dark:text-gray-500">Errors</p>
          </div>
        </div>
      </div>
    )
